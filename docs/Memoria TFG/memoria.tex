...
\noindent\includegraphics[width=\textwidth]{cabecera}\vspace{1cm}%
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=0.4\textwidth]{fastastic-roads-logo}
  \end{figure}
...
\newcommand{\nombre}{Alejandro Goicoechea Román} %%% cambio de comando

% Datos de portada
\title{\fontsize{25}{25}\selectfont Fastastic Roads \\[0.5cm] \fontsize{15}{15}\selectfont Videojuego de carreras con modo a contrarreloj}
\author{\nombre}
\tutor{Jesús María Alonso Abad y \\ Mario Alaguero Rodríguez}
\date{\today}
...
\noindent D. Jesús María Alonso Abad, profesor del departamento de Ingeniería Informática, área de Lenguajes y Sistemas Informáticos, y D. Mario Alaguero Rodríguez, profesor del Grado en Comunicación Audiovisual.

\noindent Exponen:

\noindent Que el alumno D. \nombre, con DNI 71313897M, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado Fastastic Roads. 
...
``Fastastic Roads'' es un videojuego de carreras de karts. Pretende convertirse en un videojuego didáctico mediante el cual se pueda aprender la historia de cuatro importantes ingenieras involucradas en el desarrollo y evolución de los vehículos que manejan en el juego.
...
``Fastastic Roads'' is a kart racing video game. It aims to become a didactic video game through which the history of four important female engineers involved in the development and evolution of the vehicles they drive in the game can be learned.
